...
public class AIParser extends Parser {
	...
	public static class RContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(AIParser.ID, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AIListener ) ((AIListener)listener).enterR(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AIListener ) ((AIListener)listener).exitR(this);
		}
	}
